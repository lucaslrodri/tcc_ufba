...
class captureThread(threading.Thread):
    def __init__(self, numSamples_ = 10000, delayCapture_ = 0, delayADC_ = 0, captureWindow_ = 100, oneTime_ = False, offset_ = 10, interface_refreshTime_ = 100, interface_refreshType_ = 0, ymin_ = 0, ymax_ = 4095, ymin_external_, ymax_external_, ytype_ = 1):
        ...
        self.ymin = ymin_
        self.ymax = ymax_
		self.ymin_external = ymin_external_
		self.ymax_external = ymax_external_
    ...
    def run(self):
        ...
        while(self.oneTime == False):
			...
			if(actual_time - time.clock() >= self.delayCapture/1000):
				data = bus.read_i2c_block_data(0x48, 0x00, 2)
